...
router.patch("/:id/approve", authorize("Admin", "Staff"), approveEvent);
router.patch("/:id/request-revision", authorize("Admin", "Staff"), requestRevisionEvent);
router.patch("/:id/reject", authorize("Admin", "Staff"), rejectEvent);
